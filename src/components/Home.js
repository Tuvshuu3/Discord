  ...
  return (
    <div className="Literally_Everything">
      <div className="Literally_Everything-First d-flex flex-column align-items-center w-100 justify-content-between">
        <Navbar
          className="Literally_Everything-First-Navbar"
          collapseOnSelect
          expand="lg"
          bg="#primary"
          variant="dark"
        >
          <Container>
            ...
            <Nav>
              <Link to="/login">
                <Button
                  className="Literally_Everything-First-Navbar-Button"
                  variant="light"
                >
                  Login
                </Button>
        ...
        <div className="Literally_Everything-First-Middle d-flex justify-content-center align-items-center">
          <div className="Literally_Everything-First-Middle-stuff d-flex flex-column">
            <div className="Literally_Everything-First-Middle-stuff-Text">
              <div className="Literally_Everything-First-Middle-stuff-Text-Big text-center white">
                IMAGINE A PLACE...
              </div>
              <div className="Literally_Everything-First-Middle-stuff-Text-Small white">
            ...
            <div className="Literally_Everything-First-Middle-stuff-Buttons d-flex flex-row justify-content-center">
              <Button
                href="//discord.com/api/download?platform=osx"
                className="Literally_Everything-First-Middle-stuff-Buttons-Download d-flex flex-row justify-content-evenly align-items-center"
                variant="light"
              >
              ...
              <Button
                className="Literally_Everything-First-Middle-stuff-Buttons-Open black"
                variant="dark"
              >
      ...
      <div className="carousel-stuff">
        <Carousel className='carouselImp'>
          <Carousel.Item>
        ...
        <div className="Footer">
          <div className="Footer-TopPart">
            <div className="Footer-TopPart-SocialMedia">
              <div className="Footer-TopPart-SocialMedia-Imagine">
                IMAGINE A PLACE
              </div>
              <>
                <Dropdown>
            ...
            <div className="Footer-TopPart-ALot">
              <div className="Footer-TopPart-ALot-component">
                <div className="Footer-TopPart-ALot-component-title">
                  Product
                </div>
                <div className="Footer-TopPart-ALot-component-content">
                  Download
                </div>
                <div className="Footer-TopPart-ALot-component-content">
                  Nitro
          ...
          <div className="Footer-BottomPart">
            ...
            <Button className="Footer-BottomPart-Button" variant="dark">
              Open Discord
            </Button>
          </div>
        </div>
